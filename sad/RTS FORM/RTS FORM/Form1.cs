...
//Timer Start
        ...
        private void Form1_Load(object sender, EventArgs e) { tmrTime.Start(); tmrCompute.Start(); tmrBlue1Shoot.Start(); tmrRedShoot1.Start(); tmrBuild.Start(); tmrBlueMove.Start(); tmrRedMove.Start(); }
...
// Red Tank Gets Shot
      //Tank 1
            ...
            { try { ptrRed1.BackColor = System.Drawing.Color.FromArgb(red1, 0, 0); red1 -= 25; }
                    ...
                    ptrBlueShoot1.Visible = false; lblConsole.Text = "Console: Red Tank Died"; ptrRed1.Visible = false; boolR1 = false; boolR1A = false;  
                }
            }
        //Tank 2
            ...
            {try { ptrRed2.BackColor = System.Drawing.Color.FromArgb(red2, 0, 0); red2 -= 25; }
                    ...
                    if (RedAmount == 1) RedAmount = 0; if (RedAmount == 2) RedAmount = 1; if (RedAmount == 3) RedAmount = 2; if (RedAmount == 4) RedAmount = 3;
                    ptrBlueShoot1.Visible = false; lblConsole.Text = "Console: Red Tank got shot"; ptrRed2.Visible = false; boolR2A = false; boolR2 = false;  
                }
            }
       //Tank 3
            ...
            { try { ptrRed3.BackColor = System.Drawing.Color.FromArgb(red3, 0, 0); red3 -= 25; }
                ...
                { if (RedAmount == 1) RedAmount = 0; if (RedAmount == 2) RedAmount = 1; if (RedAmount == 3) RedAmount = 2; if (RedAmount == 4) RedAmount = 3;
                ptrBlueShoot1.Visible = false; lblConsole.Text = "Console: Red Tank got shot"; ptrRed3.Visible = false; boolR3 = false; boolR3A = false;  
                }
            }
       //Tank 4
            ...
            { try { ptrRed4.BackColor = System.Drawing.Color.FromArgb(red4, 0, 0); red4 -= 25; }
                    ...
                    if (RedAmount == 1) RedAmount = 0; if (RedAmount == 2) RedAmount = 1; if (RedAmount == 3) RedAmount = 2; if (RedAmount == 4) RedAmount = 3;
                    ptrBlueShoot1.Visible = false; lblConsole.Text = "Console: Red Tank got shot"; ptrRed4.Visible = false; boolR4 = false; boolR4A = false;  
                }
            }
...
//Blue Tank Gets Shot
        //Tank 1
            ...
            { ptrRedShoot1.Visible = false;
                ...
                catch {   ptrBlue1.Enabled = false; boolB1A = false; boolB1 = false; ptrBlue1.Visible = false; lblConsole.Text = "Console: Blue Tank Died"; if (BlueAmount == 1) BlueAmount = 0; if (BlueAmount == 2) BlueAmount = 1; if (BlueAmount == 3) BlueAmount = 2; if (BlueAmount == 4)  BlueAmount = 3; }
            }
        //Tank 2
            ...
            {   ptrRedShoot1.Visible = false;
                ...
                catch {   ptrBlue2.Enabled = false; boolB2 = false; boolB2A = false; ptrBlue2.Visible = false; lblConsole.Text = "Console: Blue Tank Died"; if (BlueAmount == 1) BlueAmount = 0; if (BlueAmount == 2) BlueAmount = 1; if (BlueAmount == 3) BlueAmount = 2; if (BlueAmount == 4)  BlueAmount = 3; }
            }
        //Tank 3
            ...
            {   ptrRedShoot1.Visible = false;
                ...
                catch {   ptrBlue3.Enabled = false; boolB3 = false; boolB3A = false; ptrBlue3.Visible = false; lblConsole.Text = "Console: Blue Tank Died"; if (BlueAmount == 1) BlueAmount = 0; if (BlueAmount == 2) BlueAmount = 1; if (BlueAmount == 3) BlueAmount = 2; if (BlueAmount == 4)  BlueAmount = 3; }
            }
        //Tank 4
            ...
            {   ptrRedShoot1.Visible = false;
                ...
                catch {   ptrBlue4.Enabled = false; boolB4 = false; boolB4A = false; ptrBlue4.Visible = false; lblConsole.Text = "Console: Blue Tank Died"; if (BlueAmount == 1) BlueAmount = 0; if (BlueAmount == 2) BlueAmount = 1; if (BlueAmount == 3) BlueAmount = 2; if (BlueAmount == 4)  BlueAmount = 3; }
            }
 }
...
//Red Shoot
        private void tmrRedShoot1_Tick(object sender, EventArgs e)
        {
            if (intRedTank == 1 && boolR1 == true)
            {
                ...
                if (Controller1.ThumbSticks.Right.Y > 0f)
                {
                    ...
                    tmrRed1Down.Enabled = false; tmrRed1Right.Enabled = false; tmrRed1Left.Enabled = false; 
                }
                if (Controller1.ThumbSticks.Right.X < 0f)
                {
                    ptrRedShoot1.Location = ptrRed1.Location; ptrRedShoot1.Visible = true; tmrRed1Left.Start();
                    tmrRed1Down.Enabled = false; tmrRed1Right.Enabled = false; tmrRed1Up.Enabled = false; 
                }
                if (Controller1.ThumbSticks.Right.Y < 0f)
                {
                    ptrRedShoot1.Location = ptrRed1.Location; ptrRedShoot1.Visible = true; tmrRed1Down.Start();
                    tmrRed1Up.Enabled = false; tmrRed1Right.Enabled = false; tmrRed1Left.Enabled = false; 
                }
                if (Controller1.ThumbSticks.Right.X > 0f)
                {
                    ptrRedShoot1.Location = ptrRed1.Location; ptrRedShoot1.Visible = true; tmrRed1Right.Start();
                    tmrRed1Down.Enabled = false; tmrRed1Up.Enabled = false; tmrRed1Left.Enabled = false;
                }
            }
            if (intRedTank == 2 && boolR2 == true)
            {
        ...
        private void tmrCompute_Tick(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Blue Team Won in " + intTime.ToString() + " seconds.");
           
            if (boolB1A == false & boolB2A == false & boolB3A == false & boolB4A == false)
              MessageBox.Show("Red Team Won in " + intTime.ToString() + " seconds."); }}}